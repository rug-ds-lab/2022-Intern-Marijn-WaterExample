...
def main():
    ...
    progression of pressure in one of the nodes throughout the simulation. At the end some sample data is exported to
    a csv.
    :return:
    """
    ...
    with open('output_data/wntr_sim_data.csv', 'w') as sim_data:
